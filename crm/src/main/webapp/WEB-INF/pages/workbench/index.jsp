...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#logoutBtn").click(function (){
			window.location.href="${pageContext.request.contextPath}/settings/qx/user/logout";
		})

		window.open("${pageContext.request.contextPath}/workbench/main/index","workareaFrame");

		$("#editPwdBtn").click(function (){
			$("#editPwdForm").get(0).reset();
			$("#editPwdModal").modal("show");
		});

		$("#saveEditPwdBtn").click(function (){
			var oldPwdInDatabase = '${sessionUser.loginPwd}';
			var oldPwd = $("#oldPwd").val();
			if(oldPwdInDatabase != oldPwd){
				alert("原密码输入错误，请重新输入！")
				return;
			}
			var newPwd = $("#newPwd").val();
			var confirmPwd = $("#confirmPwd").val();
			if(oldPwdInDatabase == newPwd){
				alert("新密码与原密码不能一致，请重新输入！")
			}
			...
			$.ajax({
				url:'${pageContext.request.contextPath}/settings/qx/user/saveEditLoginPwd',
				data:{id:id, loginPwd:newPwd},
				type:'post',
				dataType:'json',
				success:function (returnObj){
					if(returnObj.flag=="1"){
						window.location.href = "${pageContext.request.contextPath}/settings/qx/user/goLogin";
					}else {
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						失效时间：<b><fmt:formatDate value="${sessionUser.expireTime}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></b><br><br>
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="saveEditPwdBtn">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" id="logoutBtn" data-dismiss="modal" >确定</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="${pageContext.request.contextPath}/settings/index"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
						<li><a href="javascript:void(0)" data-toggle="modal" data-target="#myInformation"><span class="glyphicon glyphicon-file"></span> 我的资料</a></li>
						<li><a id="editPwdBtn"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/main/index" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
				...
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/activity/index" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/clue/index" target="workareaFrame"><span class="glyphicon glyphicon-search"></span> 线索（潜在客户）</a></li>
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/customer/index" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 客户</a></li>
				<li class="liClass"><a href="contacts/index.html" target="workareaFrame"><span class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
				<li class="liClass"><a href="${pageContext.request.contextPath}/workbench/transaction/index" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
